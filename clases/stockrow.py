...
path = "D:\\Stockrow\\Income Statements" # please create this folder in your local machine
...
for ticker in tickers:
    data_1=Download_data(ticker ,Financials.Balanced_Sheet,Terms.Annual)
    print(data_1)
    data_2=Download_data(ticker ,Financials.Balanced_Sheet,Terms.Quarterly)
    print(data_2)
    data_3=Download_data(ticker ,Financials.Balanced_Sheet,Terms.Trailing)
    print(data_3)
